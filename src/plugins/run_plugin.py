"""
This script is called by the plugin-wrapper, model.js, which passes down the
...
plugin = model(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
