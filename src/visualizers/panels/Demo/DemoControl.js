...
/**
 * Generated by VisualizerGenerator 1.7.0 from webgme
 */
 ...
 define([
    ...
    const MyRunServerPlugin = function (own_self) {
        var component = {} 
        var class_info
        var myContext = own_self._client.getCurrentPluginContext('model');
        own_self._client.runServerPlugin('model', myContext, function (error, python_message) {
